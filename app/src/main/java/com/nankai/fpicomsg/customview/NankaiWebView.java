package com.nankai.fpicomsg.customview;
...
/**
 * Created by namit on 06/13/2016.
 *
 * @author namit
 */
@SuppressWarnings("deprecation")
public class NankaiWebView extends WebView {
    ...
    public NankaiWebView(Context context) {
        super(context);
        init(context);
    }

    public NankaiWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NankaiWebView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param fromUrl    the URL of the file to download, e.g. the one from `NankaiWebView.onDownloadRequested(...)`
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, NankaiWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
